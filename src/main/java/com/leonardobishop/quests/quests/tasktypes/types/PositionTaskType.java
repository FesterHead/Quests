...
// this.creatorConfigValues.add(new ConfigValue("distance-padding", false,
// "Padding zone in meters/blocks (default/unspecified = 0)."));
...
// && player.getLocation().distance(location) < padding) {
// taskProgress.setCompleted(true);
// }
// }
// }
